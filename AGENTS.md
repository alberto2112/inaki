...
main.py                          ← Compat wrapper for units generated by the old install.sh (`python main.py daemon`)
...
Raspberry Pi 5 (4GB RAM) via systemd (unit generated by `inaki service install`), `MemoryMax=2G`.
