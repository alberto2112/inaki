...
class DownloadFromTelegramTool(ITool):
    ...
    description = (
        ...
        "'file'). IMPORTANT: photos the user sent together as an ALBUM are "
        "retrieved with content_type='album' — content_type='photo' returns "
        "ONLY standalone (non-album) photos and will come back empty for album "
        "members. If an '@album' block appeared, use 'album'. "
