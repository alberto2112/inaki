...
ATTACHMENTS_SECTION = (
    ...
    "photo.\n"
    "- `@analysis (for <local_path>): <text>` — a LATE analysis of media whose "
    "block already appeared earlier in this conversation. It does NOT mean new "
    "media was sent: it completes the block that has that same path.\n"
