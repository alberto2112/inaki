...
from inaki.perception.domain.face import BBox, FaceMatch, MatchStatus, MessageFaceMetadata
...
def _dict_to_face_match(d: dict) -> FaceMatch:
    ...
    from inaki.perception.domain.face import Person  # importación local para evitar ciclos
