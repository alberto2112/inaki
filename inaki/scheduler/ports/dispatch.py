...
los adapters concretos (``ChannelRouter`` del kernel, ``ConsolidationDispatchAdapter``
y ``HttpCallerAdapter`` de este módulo, ``LLMDispatcherAdapter`` de ``inaki.agents``)
los satisfacen estructuralmente. El scheduler no importa a ``agents``: recibe el
dispatcher por este port.
"""
