...
Toda evaluación de cron pasa por ``inaki.scheduler.domain.cron`` con la timezone
...
from inaki.scheduler.domain.cron import next_cron_occurrence, resolve_timezone
