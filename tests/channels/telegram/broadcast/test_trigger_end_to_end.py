...
def _sin_delay(monkeypatch):
    ...
    """
    monkeypatch.setattr("inaki.channels.telegram.bot.GROUP_RESPONSE_DELAY_MIN_SEC", 0.0)
    monkeypatch.setattr("inaki.channels.telegram.bot.GROUP_RESPONSE_DELAY_MAX_SEC", 0.0)
