...
async def test_handle_message_pasa_ctx_a_execute():
    ...
    with patch("inaki.channels.telegram.bot.telegram_update_to_input", return_value="hola"):
...
async def test_handle_message_ctx_tiene_datos_correctos():
    ...
    with patch("inaki.channels.telegram.bot.telegram_update_to_input", return_value="texto"):
        await bot._handle_message(update, ctx)
...
async def test_handle_message_sin_input_no_llama_execute():
    ...
    with patch("inaki.channels.telegram.bot.telegram_update_to_input", return_value=None):
        await bot._handle_message(update, ctx)
