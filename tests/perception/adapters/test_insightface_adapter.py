...
from inaki.perception.domain.face import BBox, FaceDetection
...
def mock_insightface_module():
    ...
    sys.modules.pop("inaki.perception.adapters.vision.insightface_adapter", None)
    sys.modules.pop("inaki.perception.adapters.vision", None)
...
def test_if_provider_name_constant():
    ...
    from inaki.perception.adapters.vision import insightface_adapter
